...
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme).AddCookie(
    options =>
    {
        options.LoginPath = new Microsoft.AspNetCore.Http.PathString("/Utenti/Login");
        options.AccessDeniedPath = new Microsoft.AspNetCore.Http.PathString("/Utenti/Forbidden");
    });
...
builder.Services.AddAuthorization(
    options =>
    {
        ...
        options.AddPolicy("Usr", policy => policy.RequireRole("User"));
    });
